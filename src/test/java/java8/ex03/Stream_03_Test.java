...
public class Stream_03_Test {
	...
	public void test_max() throws Exception {
		...
		Optional<Order> result = orders.stream().max((order, order2) ->Double.compare(order.getPrice(),order2.getPrice()) );
	...
	public void test_min() throws Exception {
		...
		// TODO Retrouver la commande avec le prix le plus faible !??
	...
	public void test_map_collect_joining() throws Exception {
		...
		String result = customers.stream()
				...
				.reduce((firstname, acc) -> acc=acc+"|"+firstname)
